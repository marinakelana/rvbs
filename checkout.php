        ...
        if (isset($_POST["checkout"]))
        {
          ...
          $id_pembelian_barusan = $koneksi->insert_id;
            ...
            foreach ($_SESSION["keranjang"] as $id_produk => $jumlah)
             ...
             $koneksi->query("INSERT INTO pembelian_produk (id_pembelian,id_produk,nama, harga, berat, subberat,subharga, jumlah) VALUES ('$id_pembelian_barusan','$id_produk','$nama','$berat,'$harga','$subberat','$subharga',$jumlah')");
            }
            //mengkosongkan keranjang belanja setelah checkout
